...
// 1. IMPORTACIÓN EXPLÍCITA DE IMÁGENES (Igual que en tu página funcional)
import imgBooster from '../assets/booster-system.webp';
import imgCarcamoPrfv from '../assets/carcamo-prfv.webp';
import imgCarcamoPresurizado from '../assets/carcamo-presurizado.webp';
import imgContraIncendio from '../assets/contra-incendio-ul-fm.webp';
import imgTrituradora from '../assets/bomba-trituradora-desplazamiento-positivo.webp';
...
interface SiloProduct {
  ...
  siloUrl: string;
  description: string;
  imageUrl: string; // La importación entrega un string con la ruta web finalizada
  specs: string[];
}

// 2. ASIGNACIÓN DE LAS VARIABLES EN EL ARRAY (Sin comillas)
const SILO_PRODUCTS: SiloProduct[] = [
  {
    ...
    imageUrl: imgBooster, // <-- Usamos la variable importada arriba, NO un texto
  ...
  },
  {
    ...
    imageUrl: imgCarcamoPrfv, // <-- Usamos la variable importada
  ...
  },
  {
    ...
    imageUrl: imgCarcamoPresurizado, // <-- Usamos la variable importada
  ...
  },
  {
    ...
    imageUrl: imgContraIncendio, // <-- Usamos la variable importada
  ...
  {
    id: "bombas-trituradoras-axiales",
    name: "Zoeller Grinder Pumps - Bombas trituradoras",
    brand: "Zoeller",
    siloUrl: "/productos/comparativa-bombas-trituradoras",
    imageUrl: imgTrituradora, // <-- Usamos la variable importada
    description: "La bomba trituradora con la tecnología de corte más avanzada del momento, incluyendo modelos de corte bidireccional que reducen drásticamente las posibilidades de atascamiento de los equipos. Estas bombas trituradoras están desplazando a los antiguos sistemas de paso de sólidos y de trituración radial gracias a que tienen la capacidad de trabajar en las condiciones más difíciles, manejando toallas húmedas, guantes, látex, entre otros productos de difícil manejo.",
    specs: [
      "Inventario disponible para entrega inmediata",
      "Algunos modelos son bidireccionales",
      "Manejan hasta el 5% de sólidos en suspensión",
      "Cuchilla autoafilante"
    ]
  }
];
...
export const Products: React.FC = () => {
  useEffect(() => {
    document.title = "Ingeniería de Sistemas de Bombeo | SIBI";
  }, []);
